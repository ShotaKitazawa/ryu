...
class SimpleForward(app_manager.RyuApp):
    ...
    def __init__(self, *args, **kwargs):
        ...
        t = threading.Thread(target=self.server_res_check)
        t.start()
        ...
        for i in range(len(SERVER_MACADDR)):
            if i == server_res_time.index(min(server_res_time)):
                self.add_flow(datapath, OUTER_PORT, self.CLIENT_MACADDR,
                              ...
                              self.CLIENT_IPADDR, OUTER_IPADDR, INNER_PORT,
                ...
                self.add_flow(datapath, INNER_PORT, SERVER_MACADDR[i],
                              ...
                              SERVER_IPADDR[i], INNER_IPADDR, OUTER_PORT,
                              TCP_HTTP, count,
